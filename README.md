...
* [**G**entoo](https://www.gentoo.org/donate/)
...
* [**A**rkenfox user.js (Firefox hardening)](https://github.com/arkenfox/user.js) (no donations yet)
* [**A**udacity](https://audacityteam.org) [No money donations anymore](https://forum.audacityteam.org/t/is-it-possible-to-donate-money-to-this-project/61593)
* [**B**lissOS / Waydroid](https://opencollective.com/blisslabs/donate)
* [**B**ottles (Easy Wine Configuration)](https://usebottles.com/funding/)
* [**C**alibre E-Book Manager](https://calibre-ebook.com/get-involved) (Javascript button on the top right)
* [**C**lementine](https://www.clementine-player.org/) (audio player) – no money accepted
* [**C**ryptomator](https://cryptomator.org/donate/)
...
* [**J**amesDSP for Linux](https://github.com/ThePBone) [KoFi](https://ko-fi.com/thepbone) [PayPal](https://paypal.me/timschneeberger)
...
### For Companies:
* [**Q**EMU](https://www.qemu.org/sponsors/)
* [**X**MPP](https://xmpp.org/community/sponsors/)
...
* [**L**emmy](https://join-lemmy.org/donate)
...
* [**C**oreboot](https://www.coreboot.org/donate.html)
* [**D**asharo](https://docs.dasharo.com/) (no donations but purchases of Hardware)
* [**L**ibreboot](https://libreboot.org/) [Patreon](https://www.patreon.com/libreleah)
* [**M**rChromeBox](https://mrchromebox.tech) (Coreboot for Chromebooks)
* [**N**ovaCustom](https://configurelaptop.eu) (Company)
* [**S**tarlabs Systems](https://starlabs.systems)
* [**S**kulls (preconfigured Coreboot)](https://github.com/merge/skulls/) [Github Sponsors](https://github.com/sponsors/merge)
